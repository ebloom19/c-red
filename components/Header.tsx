...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b-8 border-[#f30000] bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 flex flex-col items-center justify-center">
